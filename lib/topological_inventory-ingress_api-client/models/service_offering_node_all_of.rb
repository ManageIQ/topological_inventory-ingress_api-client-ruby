...
module TopologicalInventoryIngressApiClient
  class ServiceOfferingNodeAllOf
    ...
    attr_accessor :root_service_offering
    ...
    def self.attribute_map
      {
        ...
        :'root_service_offering' => :'root_service_offering',
    ...
    def self.openapi_types
      {
        ...
        :'root_service_offering' => :'ServiceOfferingReference',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TopologicalInventoryIngressApiClient::ServiceOfferingNodeAllOf` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TopologicalInventoryIngressApiClient::ServiceOfferingNodeAllOf`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'root_service_offering')
        self.root_service_offering = attributes[:'root_service_offering']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          root_service_offering == o.root_service_offering &&
    ...
    def hash
      [archived_at, extra, name, resource_timestamp, root_service_offering, service_credential, service_inventory, service_offering, source_created_at, source_ref, source_updated_at].hash
    end
