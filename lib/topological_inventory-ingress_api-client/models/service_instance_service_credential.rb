...
module TopologicalInventoryIngressApiClient
  class ServiceInstanceServiceCredential
    ...
    def self.openapi_all_of
      [
      :'InventoryObject',
      :'ServiceInstanceServiceCredentialAllOf'
      ]
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TopologicalInventoryIngressApiClient::ServiceInstanceServiceCredential` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TopologicalInventoryIngressApiClient::ServiceInstanceServiceCredential`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'service_instance')
        self.service_instance = attributes[:'service_instance']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @service_instance.nil?
        invalid_properties.push('invalid value for "service_instance", service_instance cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @service_instance.nil?
      true
    end
    ...
    def hash
      [service_credential, service_instance].hash
    end
