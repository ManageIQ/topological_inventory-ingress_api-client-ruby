...
# Unit tests for TopologicalInventoryIngressApiClient::ServiceOfferingAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ServiceOfferingAllOf' do
  before do
    # run before each test
    @instance = TopologicalInventoryIngressApiClient::ServiceOfferingAllOf.new
  end
  ...
  describe 'test an instance of ServiceOfferingAllOf' do
    it 'should create an instance of ServiceOfferingAllOf' do
      expect(@instance).to be_instance_of(TopologicalInventoryIngressApiClient::ServiceOfferingAllOf)
    end
  end
